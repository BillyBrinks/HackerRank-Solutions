...
public class Java_Interface {
	 ...
	 *The interface can be used to achieve polymorphism. In this problem, 
	 *you will practice your knowledge of interfaces.
	  ...
	  divisorSum function just takes an integer as input and returns the 
